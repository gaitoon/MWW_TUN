...
function saveAiNames(){
  ...
  try { localStorage.setItem('mw_ai_names', JSON.stringify(AI_NAMES)); } catch(e){}
...
function startChkobbaRound(){
  ...
  // Show round banner first, then deal
  // Show round banner first, then deal
  showRoundBanner(G.round, 99, ()=>{
    // Deal cards after banner
    ...
    G.busy = false;
    if(G.mp && MP.isHost){ MP.snapshotDirty=true; mpSendSnapshot({newRound:true}); }
...
function initRamiGame(rounds,difficulty='medium',playerCount=2){
  ...
  if(playerCount===4){
    players=[
      ...
      {id:1,name:AI_NAMES[1],score:0,hand:[],laidMelds:[],isAI:true},
      {id:2,name:AI_NAMES[0],score:0,hand:[],laidMelds:[],isAI:true},
      {id:3,name:AI_NAMES[2],score:0,hand:[],laidMelds:[],isAI:true},
    ];
  } else {
    players=[
      {id:0,name:'YOU',      score:0,hand:[],laidMelds:[],isAI:false},
      {id:1,name:AI_NAMES[0],score:0,hand:[],laidMelds:[],isAI:true},
    ];
  }
  // Build hasOpened map
